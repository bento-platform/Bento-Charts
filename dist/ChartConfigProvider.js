...
export var useChartTheme = function () { return useContext(ChartThemeContext); };
var ChartTranslationContext = React.createContext(defaultTranslationObject.en);
export var useChartTranslation = function () { return useContext(ChartTranslationContext); };
